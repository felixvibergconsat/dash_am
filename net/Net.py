...
class Net(nn.Module):
    def __init__(self, size):
        ...
        self.do1 = nn.Dropout(0.01)
        self.do2 = nn.Dropout(0.01)
        self.do3 = nn.Dropout(0.01)
        self.do4 = nn.Dropout(0.01)
        self.do5 = nn.Dropout(0.01)
        self.do6 = nn.Dropout(0.01)
        self.do7 = nn.Dropout(0.01)
        self.do8 = nn.Dropout(0.01)
        self.do9 = nn.Dropout(0.01)
